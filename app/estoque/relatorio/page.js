            ...
            <table className="w-full text-sm table-fixed">
              <thead>
                <tr className="bg-canvas border-b border-line text-[10px] uppercase tracking-wide text-muted font-mono">
                  <th className="text-left px-2.5 py-2.5 whitespace-nowrap" style={{ width: "5%" }}>Pedido</th>
                  <th className="text-left px-2.5 py-2.5 whitespace-nowrap" style={{ width: "16%" }}>Cliente</th>
                  <th className="text-left px-2.5 py-2.5 whitespace-nowrap" style={{ width: "9%" }}>Código</th>
                  <th className="text-center px-2.5 py-2.5 whitespace-nowrap" style={{ width: "4%" }}>Qtd</th>
                  <th className="text-right px-2.5 py-2.5 whitespace-nowrap" style={{ width: "8%" }}>Custo</th>
                  <th className="text-right px-2.5 py-2.5 whitespace-nowrap" style={{ width: "7%" }}>Imposto</th>
                  <th className="text-right px-2.5 py-2.5 whitespace-nowrap" style={{ width: "9%" }}>Venda bruta</th>
                  <th className="text-right px-2.5 py-2.5 whitespace-nowrap" style={{ width: "8%" }}>Desconto</th>
                  <th className="text-right px-2.5 py-2.5 whitespace-nowrap" style={{ width: "9%" }}>Venda líquida</th>
                  <th className="text-right px-2.5 py-2.5 whitespace-nowrap" style={{ width: "9%" }}>Lucro líquido</th>
                  <th className="text-right px-2.5 py-2.5 whitespace-nowrap" style={{ width: "6%" }}>% Lucro</th>
                  <th className="text-right px-2.5 py-2.5 whitespace-nowrap" style={{ width: "10%" }}>Pago no pedido</th>
                </tr>
              </thead>
              <tbody>
                {calculadas.map((l) => (
                  <tr key={l.id} className="border-b border-line last:border-0 hover:bg-canvas">
                    <td className="px-2.5 py-2.5 font-mono text-muted whitespace-nowrap">#{l.orcamentos?.numero_unidade}</td>
                    <td className="px-2.5 py-2.5 whitespace-nowrap overflow-hidden text-ellipsis">{l.orcamentos?.clientes?.nome || "—"}</td>
                    <td className="px-2.5 py-2.5 font-mono whitespace-nowrap" style={{ color: "var(--accent)" }}>{l.codigo}</td>
                    <td className="px-2.5 py-2.5 text-center whitespace-nowrap">{l.qtd}</td>
                    <td className="px-2.5 py-2.5 text-right font-mono whitespace-nowrap">{fmtBRL(l.custoTotal)}</td>
                    <td className="px-2.5 py-2.5 text-right font-mono whitespace-nowrap">{fmtBRL(l.impostoValor)}</td>
                    <td className="px-2.5 py-2.5 text-right font-mono whitespace-nowrap text-muted">{fmtBRL(l.vendaBruta)}</td>
                    <td className="px-2.5 py-2.5 text-right font-mono whitespace-nowrap" style={{ color: l.descontoItem > 0.004 ? "#D6336C" : undefined }}>
                      {l.descontoItem > 0.004 ? `-${fmtBRL(l.descontoItem)}` : "—"}
                    </td>
                    <td className="px-2.5 py-2.5 text-right font-mono font-semibold whitespace-nowrap">{fmtBRL(l.vendaLiquida)}</td>
                    <td className="px-2.5 py-2.5 text-right font-mono font-semibold whitespace-nowrap" style={{ color: "#2C7C6E" }}>{fmtBRL(l.lucroLiquido)}</td>
                    <td className="px-2.5 py-2.5 text-right font-mono whitespace-nowrap">{l.percentualLucro.toFixed(1)}%</td>
                    <td className="px-2.5 py-2.5 text-right font-mono whitespace-nowrap">{fmtBRL(l.totalPagoPedido)}</td>
                  </tr>
                ))}
              </tbody>
            </table>
