import { FileSearch, PackageSearch, Truck, PackageCheck, Receipt, PackageOpen, XCircle, CheckCircle2, Ban } from "lucide-react";
...
export const CORES_STATUS = {
  ...
  "Peça Indisponível Samsung": { bg: "rgba(214,51,108,0.14)", fg: "#D6336C" },
...
// Bandeiras mais usadas — exibidas só quando a forma de pagamento é "Cartão de Crédito".
export const BANDEIRAS_CARTAO = ["Visa", "Mastercard", "Elo", "American Express", "Hipercard", "Diners Club", "Outra"];

// Parcelamento de 1x até 10x, também só pra Cartão de Crédito.
export const PARCELAS_CARTAO = Array.from({ length: 10 }, (_, i) => i + 1);
