...
// JM3 Cliente só vê os próprios pedidos, pelo mesmo motivo (RLS restringe por
// cliente_id = meu_cliente_id()) — é acesso de visualização: JM3 Cliente não
// entra em CARGOS_GERENCIA_FISCAL, então não pode registrar/corrigir NF.
export const CARGOS_FISCAL = ["Administrador", "Diretor", "Gerente", "Supervisor", "Estoque", "Financeiro", "Vendedor", "JM3 Cliente"];
