...
export const CARGOS_FISCAL = ["Administrador", "Diretor", "Gerente", "Estoque", "Financeiro", "Vendedor"];

// Quem consegue de fato registrar/corrigir a NF do pedido (bate com a policy
// pode_gerenciar_fiscal() do banco).
export const CARGOS_GERENCIA_FISCAL = ["Administrador", "Diretor", "Gerente", "Estoque", "Financeiro"];
