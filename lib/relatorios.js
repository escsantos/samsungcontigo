...
// Quem enxerga o menu/dashboard de Relatórios. JM3 Cliente só vê o Resumo
// (nunca Comissões nem Visão 360º, que não estão nessa lista) — a RLS de
// "ver orcamentos"/"ver itens de orcamento" já restringe automaticamente
// aos pedidos do próprio cliente (cliente_id = meu_cliente_id()), então
// nenhuma mudança de RLS foi necessária pra isso.
export const CARGOS_RELATORIOS = ["Administrador", "Diretor", "Gerente", "Supervisor", "Vendedor", "JM3 Cliente"];
...
// Relatório de Comissões: Vendedor só acompanha a própria comissão; os
// demais acompanham a de todos os vendedores vinculados à unidade ativa.
export const CARGOS_COMISSOES_TODOS = ["Administrador", "Diretor", "Gerente", "Supervisor", "Financeiro"];
export const CARGOS_COMISSOES = [...CARGOS_COMISSOES_TODOS, "Vendedor"];

// Visão 360º: painel executivo consolidado — só a liderança da unidade.
export const CARGOS_VISAO_360 = ["Administrador", "Diretor", "Gerente", "Supervisor"];
