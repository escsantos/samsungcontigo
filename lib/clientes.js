...
// J MACEDO ELETRONICA LTDA — CNPJ 01.405.991/0003-17. Cliente com regras de
// preço próprias: venda sempre pelo valor de custo (margem e imposto
// zerados) e pagamento no fechamento da semana, sem exigência de
// adiantamento. Mesmo CNPJ usado na trava de banco (trigger fixar_cliente_jm3
// em supabase/schema.sql) e no vínculo do cargo JM3 Cliente.
export const CNPJ_CLIENTE_CUSTO_ZERO = "01405991000317";

export function ehClienteCustoZero(cnpj) {
  return apenasNumeros(cnpj) === CNPJ_CLIENTE_CUSTO_ZERO;
}
