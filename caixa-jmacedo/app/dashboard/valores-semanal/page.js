...
function ConteudoDashboard() {
  ...
  async function carregar() {
    setCarregando(true);
    const dados = filtrarPorMarca(await buscarValoresPorPeriodo(supabase, semana.inicio, diaSeguinte(semana.fim), linhaFiltro, detalharLinha), marcasFiltro);
  ...
  useEffect(() => {
    carregar();
  }, [linhaFiltro, marcasFiltro, detalharLinha, semanaSelecionada]); // eslint-disable-line react-hooks/exhaustive-deps
